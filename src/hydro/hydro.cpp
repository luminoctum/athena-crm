...
Hydro::Hydro(MeshBlock *pmb, ParameterInput *pin)
{
  ...
  wl_.NewAthenaArray(nthreads,(NWAVE),std::max(ncells1,std::max(ncells2,ncells3)));
  wr_.NewAthenaArray(nthreads,(NWAVE),std::max(ncells1,std::max(ncells2,ncells3)));
  flx_.NewAthenaArray(nthreads,(NWAVE),std::max(ncells1,std::max(ncells2,ncells3)));
